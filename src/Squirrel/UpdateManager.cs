...
namespace Squirrel
{
    public sealed partial class UpdateManager : IUpdateManager, IEnableLogger
    {
        ...
        public void CreateShortcutsForExecutable(string exeName, ShortcutLocation locations, bool updateOnly, bool sharedByAllUsers = false)
        {
            var installHelpers = new ApplyReleasesImpl(rootAppDirectory);
            installHelpers.CreateShortcutsForExecutable(exeName, locations, updateOnly, sharedByAllUsers);
        }
